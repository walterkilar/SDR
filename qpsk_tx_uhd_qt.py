...
# Generated: Sun Mar 17 13:36:30 2019
##################################################
...
class qpsk_tx_uhd_qt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        dtv.C1_4, dtv.MOD_QPSK, dtv.INTERPOLATION_OFF)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_throttle_0_0_0, 0))
        ...
        self.connect((self.dtv_dvbs2_modulator_bc_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
